package de.dhbw.binaeratops.views.personal;

import de.dhbw.binaeratops.data.entity.SamplePerson;
import de.dhbw.binaeratops.data.service.SamplePersonService;
...
@PageTitle("Personal")
@CssImport("./views/personal/personal-view.css")
public class PersonalView extends Div {
    ...
    public PersonalView(SamplePersonService personService) {
